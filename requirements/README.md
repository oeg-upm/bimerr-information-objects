...
<table style="width:100%; border: 1px solid">
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The purpose of this model is to represent the files and documents generated during a building renovation project and are stored as information objects in the BIMERR Interoperability Framework.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The scope of this ontology is limited to the files shared through the BIF.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>All the applications that share and store files in BIF.</td>
  </tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>Exchange and store files as information objects.</td>
  </tr>
...
<tr>
  ...
  <tr>
    <td style="width:5%"></td>
    <td>The whole set of functional requirements is located <a href="https://github.com/oeg-upm/bimerr-information-objects/blob/master/requirements">here</a> </td>
  </tr>
